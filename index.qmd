...
Please drop your details on the [updates](updates.qmd) page to recieve an email notification when a new chapter is available. You can also join the [Zulip community](https://dmbook.zulipchat.com/join/vntv532nhvexfidomkqsybwq/) to participate in discussions around the chapters. Feel free to send me an email at `neeldhara.misra@gmail.com` if you have any questions, or drop a comment below. Thanks for your interest in this project :) 
